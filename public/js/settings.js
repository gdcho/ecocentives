...
firebase.auth().onAuthStateChanged(async function (user) {
  if (user) {
    ...
    const recyclingReminders = localStorage.getItem("recyclingReminders") === "true";
    ...
    const connectInstagram = localStorage.getItem("connectInstagram") === "true";
    ...
    saveBtn.addEventListener("click", async (event) => {
      ...
      const recyclingReminders = document.getElementById("recycling-reminders").checked;
      ...
      const connectInstagram = document.getElementById("connect_instagram").checked;
